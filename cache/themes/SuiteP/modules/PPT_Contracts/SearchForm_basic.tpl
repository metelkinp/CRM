...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='name_basic'> {sugar_translate label='LBL_NAME' module='PPT_Contracts'}</label>
					</div>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='account_name_basic' >{sugar_translate label='LBL_ACCOUNT' module='PPT_Contracts'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{html_options id='account_name_basic' name='account_name_basic[]' options=$fields.account_name_basic.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.account_name_basic.value}
		</div>
		<div class="search-clear"></div>
	</div>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='PPT_Contracts'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
